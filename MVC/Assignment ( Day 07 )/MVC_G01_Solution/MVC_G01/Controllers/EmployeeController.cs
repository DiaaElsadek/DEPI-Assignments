...
namespace MVC_G01.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            Employee employee=_employeeRepository.GetByIdWithLoading(id);
        ...
        { 
            ...
            // 1-Source 
            Employee EmpModel = _employeeRepository.GetByIdWithLoading(id);
            int Rate = 67;
            string Status = "B";
            List<string> Skills = new List<string>() { "Communication", "TeamWork" };
        ...
        public IActionResult Edit(int id)
        {
            ...
            // Sources
            //Employee
            Employee Emp = _employeeRepository.GetByIdWithLoading(id);
            //List<Dept>
            List<Department> DeptList = _departmentRepository.GetAll();
        ...
        public IActionResult SaveEdit(Employee NewEmp,int id)
        {
            // Updating
            // oldEmp
            Employee OldEmp = _employeeRepository.GetByIdWithLoading(id);
            if(NewEmp.Name != null)
        ...
        {
            return View("Delete",_employeeRepository.GetByIdWithLoading(id));
        }
        ...
        {
            ViewData["DeptList"]=new SelectList(_departmentRepository.GetAll(),"Id","Name");
